...
/* UART functions                                
 ...
 step 1- changed the systemclock and baut rate.
 
 step 2 - UART registers configured according to ATMega32 like,UCSR0B to UCSRB  */
...
typedef struct _fifo {
	...
	uint8_t	idx_r;
	uint8_t	count;
	uint8_t buff[64];//WILL CHANGE THIS
} FIFO;
